...
{
    public class PharSubStoreSalesGateway : DbConnection
    {
            ...
            try
            {
             ...
             //   aModel.ForEach(z => z.SubSubPnoId = 65);
                ...
                foreach (var salesMain in aModel)
                {
                    ...
                    int subSubPnoId = aModel.ElementAt(0).SubSubPnoId;
                    ...
                    foreach (var item in listItem)
                    {
                        if (salesMain.Quantity != 0)
                        {
                            if (salesMain.Quantity >= item.TotalQuantity)
                            {
                                ...
                                var query_sl1 = @"INSERT INTO tbl_PHAR_STOCKLEDGER (RefNo,RefDate,InvoiceNo,InvoiceDate,CompanyId,ItemId,BarCodeId,OutQty,PurchasePrice,SalesPrice,ExpireDate,Status,SubSubPnoId,UserName,BranchId,EntryTime) VALUES (@RefNo,@RefDate,@InvoiceNo,@InvoiceDate,@CompanyId,@ItemId,@BarCodeId,@OutQty,@PurchasePrice,@SalesPrice,@ExpireDate,@Status,@SubSubPnoId,@UserName,@BranchId,@EntryTime)";
                                ...
                                var query_sd1 = @"INSERT INTO tbl_PHAR_SALES_DETAIL (InvMasterId,ItemId,CompanyId,ProductQty,SalesPrice,AvgPurchasePrice) VALUES (@InvMasterId,@ItemId,@CompanyId,@ProductQty,@SalesPrice,@AvgPurchasePrice)";
                            ...
                            {
                                var query_sl2 = @"INSERT INTO tbl_PHAR_STOCKLEDGER (RefNo,RefDate,InvoiceNo,InvoiceDate,CompanyId,ItemId,BarCodeId,OutQty,PurchasePrice,SalesPrice,ExpireDate,Status,SubSubPnoId,UserName,BranchId,EntryTime) VALUES(@RefNo,@RefDate,@InvoiceNo,@InvoiceDate,@CompanyId,@ItemId,@BarCodeId,@OutQty,@PurchasePrice,@SalesPrice,@ExpireDate,@Status,@SubSubPnoId,@UserName,@BranchId,@EntryTime)";
                                ...
                                //  tbl_PHAR_SALES_DETAIL
                                var query_sd2 = @"INSERT INTO tbl_PHAR_SALES_DETAIL (InvMasterId,ItemId,CompanyId,ProductQty,SalesPrice,AvgPurchasePrice,BarCodeId) VALUES (@InvMasterId,@ItemId,@CompanyId,@ProductQty,@SalesPrice,@AvgPurchasePrice,@BarCodeId)";
        ...
        public int GetPharStock(int searchString, string userName,int pno)
        {
            try
            {
                int branchId = 0;
