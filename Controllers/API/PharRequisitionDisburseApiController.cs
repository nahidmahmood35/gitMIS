...
{
    public class PharRequisitionDisburseApiController : ApiController
    {


       PharRequisitionDisburseGateway _gt=new PharRequisitionDisburseGateway();
        ...
        public HttpResponseMessage GetPharRequisitionListTable(string userName)
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, _gtAll.GetPharRequisitionList("0", 3, userName), formatter);
        }
