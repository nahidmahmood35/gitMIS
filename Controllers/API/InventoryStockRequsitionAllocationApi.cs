...
{
    public class InventoryStockRequsitionAllocationApiController : ApiController
    {
        readonly InventoryStockRequsitionAllocationGateway _gt = new InventoryStockRequsitionAllocationGateway();
