...
{
    public class InventoryStockRequsitionApproveApiController : ApiController
    {
        readonly InventoryStockRequsitionApproveGateway _gt = new InventoryStockRequsitionApproveGateway();
